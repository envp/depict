...
//		mv.visitFieldInsn(Opcodes.GETSTATIC, "cop5556sp17/PLPRuntimeLog", "globalLog", "Lcop5556sp17/PLPRuntimeLog;");
            mv.visitLdcInsn(message);
            mv.visitMethodInsn(
                Opcodes.INVOKESTATIC, "cop5556sp17/PLPRuntimeLog", "globalLogAddEntry", "(Ljava/lang/String;)V", false);
        }
    }
...
//			mv.visitInsn(Opcodes.SWAP);
            switch( type )
            {
                case INTEGER:
                {
                    ...
                    mv.visitMethodInsn(
                        Opcodes.INVOKESTATIC, "cop5556sp17/PLPRuntimeLog", "globalLogAddEntry", "(Ljava/lang/String;)V",
                        false
                    );
                }
                break;
                case BOOLEAN:
                {
                    mv.visitInsn(Opcodes.DUP);
                    mv.visitMethodInsn(
                        Opcodes.INVOKESTATIC, "java/lang/Boolean", "toString", "(Z)Ljava/lang/String;", false);
                    mv.visitMethodInsn(
                        Opcodes.INVOKESTATIC, "cop5556sp17/PLPRuntimeLog", "globalLogAddEntry", "(Ljava/lang/String;)V",
                        false
                    );
