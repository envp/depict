 ...
 */
public class ParserTestExhaustive
{
    private static final Random rnd = new Random();
    private static final int MAX_DEPTH = 30;
    private static final int MAX_PROG_LEN = 100;
    ...
    private static class StrongOpGenerator implements Generator
    {
        ...
        public StringBuilder next()
        {
            ...
            {
                return new StringBuilder(StrongOpGenerator.STRONG_OPS[ParserTestExhaustive.rnd.nextInt(4)]);
            }
        }
    ...
    private static class WeakOpGenerator implements Generator
    {
        ...
        public StringBuilder next()
        {
            ...
            {
                return new StringBuilder(WeakOpGenerator.WEAK_OPS[ParserTestExhaustive.rnd.nextInt(3)]);
            }
        }
    ...
    private static class RelOpGenerator implements Generator
    {
        ...
        public StringBuilder next()
        {
            ...
            {
                return new StringBuilder(RelOpGenerator.REL_OPS[ParserTestExhaustive.rnd.nextInt(6)]);
            }
        }
    ...
    private static class FactorGenerator implements Generator
    {
        ...
        {
            index = 0;
            if( curDepth < ParserTestExhaustive.MAX_DEPTH )
            {
    ...
    private static class ElemGenerator implements Generator
    {
        ...
        public StringBuilder next()
        {
            if( facG != null && facG.hasNext() )
            {
                ...
                for( int i = 0; i < ParserTestExhaustive.rnd.nextInt(3) && facG.hasNext(); i++ )
                {
                    if( !stOpG.hasNext() )
                    {
            ...
            {
                return new StringBuilder(new FactorGenerator(ParserTestExhaustive.MAX_DEPTH).next());
            }
        }
    ...
    private static class TermGenerator implements Generator
    {
        ...
        public StringBuilder next()
        {
            if( elemG != null && elemG.hasNext() )
            {
                ...
                for( int i = 0; i < ParserTestExhaustive.rnd.nextInt(3) && elemG.hasNext(); i++ )
                {
                    if( !wkOpG.hasNext() )
                    {
                        wkOpG = new WeakOpGenerator();
            ...
            {
                return new StringBuilder(new ElemGenerator(ParserTestExhaustive.MAX_DEPTH).next());
            }
        }
    ...
    private static class ExpressionGenerator implements Generator
    {
        ...
        public StringBuilder next()
        {
            if( termG != null && termG.hasNext() )
            {
                ...
                for( int i = 0; i < ParserTestExhaustive.rnd.nextInt(3) && termG.hasNext(); i++ )
                {
                    if( !rlOpG.hasNext() )
                    {
                        rlOpG = new RelOpGenerator();
            ...
            {
                return new StringBuilder(new TermGenerator(ParserTestExhaustive.MAX_DEPTH).next());
            }
        }
    ...
    private static class ArgGenerator implements Generator
    {
        ...
        public ArgGenerator()
        {
            this(ParserTestExhaustive.MAX_DEPTH - 1);
        }
        ...
        public StringBuilder next()
        {
            if( expG != null && expG.hasNext() )
            {
                if( (ParserTestExhaustive.rnd.nextInt(2)) > 0 )
                {
                    StringBuilder result = new StringBuilder("(");
                    result.append(expG.next());
                    for( int i = 0; i < (ParserTestExhaustive.rnd.nextInt(3)) && expG.hasNext(); i++ )
                    {
    ...
    private static class ImageOpGenerator implements Generator
    {
        ...
        public StringBuilder next()
        {
            ...
            {
                return new StringBuilder(ImageOpGenerator.IMAGE_OPS[ParserTestExhaustive.rnd.nextInt(3)]);
            }
        }
    ...
    private static class FrameOpGenerator implements Generator
    {
        ...
        public StringBuilder next()
        {
            ...
            {
                return new StringBuilder(FrameOpGenerator.FRAME_OPS[ParserTestExhaustive.rnd.nextInt(5)]);
            }
        }
    ...
    private static class FilterOpGenerator implements Generator
    {
        ...
        public StringBuilder next()
        {
            ...
            {
                return new StringBuilder(FilterOpGenerator.FILTER_OPS[ParserTestExhaustive.rnd.nextInt(3)]);
            }
        }
    ...
    private static class ArrowOpGenerator implements Generator
    {
        ...
        public StringBuilder next()
        {
            ...
            {
                return new StringBuilder(ArrowOpGenerator.ARROW_OPS[ParserTestExhaustive.rnd.nextInt(2)]);
            }
        }
    ...
    private static class IfStatementGenerator implements Generator
    {
        ...
        public StringBuilder next()
        {
            ...
            {
                result.append(new ExpressionGenerator(ParserTestExhaustive.MAX_DEPTH).next());
                result.append(" ) ");
                result.append(new BlockGenerator(ParserTestExhaustive.MAX_DEPTH).next());
            }
            return result;
        }
    ...
    private static class ChainGenerator implements Generator
    {
        ...
        public StringBuilder next()
        {
            if( chainElemG != null && chainElemG.hasNext() )
            {
                ...
                {
                    result.append(new ChainElemGenerator(ParserTestExhaustive.MAX_DEPTH - 1).next()); //this is cheating
                }
                else
                {
                    result.append(chainElemG.next());
                }
                for( int i = 0; (i < (ParserTestExhaustive.rnd.nextInt(3))) && chainElemG.hasNext(); i++ )
                {
                    if( !arrowG.hasNext() )
                    {
                        arrowG = new ArrowOpGenerator();
            ...
            {
                return new StringBuilder(new ChainElemGenerator(ParserTestExhaustive.MAX_DEPTH).next())
                    .append(new ArrowOpGenerator().next())
                    .append(new ChainElemGenerator(ParserTestExhaustive.MAX_DEPTH).next());
            }
        }
        ...
        public StringBuilder next()
        {
            ...
            switch( index )
            {
                ...
                case 4:
                    ...
                    break;
                default:
                    result.append(new AssignGenerator(ParserTestExhaustive.MAX_DEPTH).next())
                          .append(";\n");
            }
            return result;
        }
    ...
    private static class DecGenerator implements Generator
    {
        ...
        public StringBuilder next()
        {
            ...
            {
                return new StringBuilder(DecGenerator.DEC[ParserTestExhaustive.rnd.nextInt(4)])
                    .append(" dummyIdent ");
            }
        }
    ...
    private static class BlockGenerator implements Generator
    {
        ...
        public StringBuilder next()
        {
            ...
            {
                for( int i = 0; i < (ParserTestExhaustive.rnd.nextInt(ParserTestExhaustive.MAX_PROG_LEN / 2)); i++ )
                {
            ...
            else
            {
                ...
                result.append(new StatementGenerator(ParserTestExhaustive.MAX_DEPTH).next());
            }
            result.append("}\n");
            return result;
        }
    ...
    private static class ParamDecGenerator implements Generator
    {
        ...
        public StringBuilder next()
        {
            ...
            {
                return new StringBuilder(ParamDecGenerator.PARAM_DEC[ParserTestExhaustive.rnd.nextInt(4)])
                    .append(" dummyIdent\n");
            }
        }
    ...
    private static class ProgramGenerator implements Generator
    {
        ...
        public StringBuilder next()
        {
            ...
            if( index == 0 && blockG.hasNext() )
            {
                ...
                {
                    index++;
                    blockG = new BlockGenerator(ParserTestExhaustive.MAX_DEPTH - 1);
                }
            }
            else if( index == 1 && blockG.hasNext() )
            {
                ...
                for( int i = 0; i < (ParserTestExhaustive.rnd.nextInt(2)) && paramG.hasNext(); i++ )
                {
                    result.append(",");
                    result.append(paramG.next());
                }
